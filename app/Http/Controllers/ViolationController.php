...
class ViolationController extends Controller
{
    ...
    public function groupByAndCount(Request $request)
    {
        ...
        $data->violation_ticket_count_within_date = Violation::with('tickets', function($query) use ($within_date_ids) {
        ...
        $data->all_violation_ticket_count = Violation::with('tickets', function($query) use ($all_ids) {
